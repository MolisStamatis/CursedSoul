...
Main.text.initialize = function () {
    ...
    text.get('ui').set('studio', 'Forge-Games ©2022');
    ...
    text.get('action').set('deathGeneral', 'Rest in peace, cursed one.');

    text.get('action').set('deathBoss1',
        'cursed one, hearest thou my voice, still?'
    );
    ...
    text.get('help').set('keyBindings',
        ...
        + 'Please read the '
        + Main.screens.colorfulText('Forums', 'green')
    ...
    text.get('cutScene').set('enterLevel1',
        ...
        + ' One of the voices is calling you: come down to me, cursed one.'
    );
